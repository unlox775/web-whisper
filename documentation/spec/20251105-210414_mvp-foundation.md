...
**Last updated:** 2025-11-09 20:14 UTC
...
- Detects real audio flow and arms a 15 s timer; if no playable payload arrives, a low-volume tone plays, capture stops automatically, and the session lands in the existing “no audio captured” error state.
- Clears the watchdog once audio chunking starts and logs the detection to aid debugging.
