...
- **2025-11-09T20:40Z** – Follow-up: watchdog failed to abort; tighten detection to real audio amplitude and cut the timeout to 9 s.
...
- Clears the watchdog once meaningful audio arrives, logging the measured levels for later inspection.
