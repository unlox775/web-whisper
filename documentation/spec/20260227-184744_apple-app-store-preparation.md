...
- 2026-02-28: Next: restore the core architecture in iOS native mode by rotating native recordings into ~4s chunks (persisted on-device) and importing chunks into IndexedDB incrementally, instead of importing one full-session file on stop.
