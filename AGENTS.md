...
- Spec files must include planning notes, todos, acceptance criteria, a summary of edits (what/where/why), and a self-evaluation against the acceptance criteria.
